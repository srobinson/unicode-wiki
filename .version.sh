...
if [[ $TRAVIS_BRANCH == 'master' ]]; then
  ...
  # const token="90ab0ffb7d177a4a937583bdff0140ef64e8402b"
  ...
  curl -H "Authorization: token 90ab0ffb7d177a4a937583bdff0140ef64e8402b" https://github.com/srobinson/unicode-wiki > /dev/null
