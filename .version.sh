...
if [[ $TRAVIS_BRANCH == 'master' ]]; then
  ...
  # const token="caa09f7e75edc6d50666bd6c5cc28c9f17a7ebf4"
  ...
  # curl -H "Authorization: token caa09f7e75edc6d50666bd6c5cc28c9f17a7ebf4" https://github.com/srobinson/unicode-wiki > /dev/null
