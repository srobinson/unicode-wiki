...
/* MOBILE */
/* https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=ext.cite.styles|mediawiki.skinning.interface|skins.vector.styles&only=styles&skin=vector */
// https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=ext.3d.styles|ext.cite.styles|ext.uls.interlanguage|ext.visualEditor.desktopArticleTarget.noscript|ext.wikimediaBadges|mediawiki.legacy.commonPrint,shared|mediawiki.page.gallery.styles|mediawiki.skinning.interface|mediawiki.toc.styles|skins.vector.styles|wikibase.client.init&only=styles&skin=vector
// https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=site.styles&only=styles&skin=vector

// https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=ext.gadget.charinsert-styles|ext.3d.styles|ext.cite.styles|ext.uls.interlanguage|ext.visualEditor.desktopArticleTarget.noscript|ext.wikimediaBadges|mediawiki.legacy.commonPrint%2Cshared|mediawiki.page.gallery.styles|mediawiki.skinning.interface|mediawiki.toc.styles|skins.vector.styles|wikibase.client.init&only=styles&skin=vector
...
.wiki {
  ...
  ul.mw-gallery-packed-hover li.gallerybox div.gallerytextwrapper:hover p,ul.mw-gallery-packed-overlay li.gallerybox div.gallerytextwrapper:hover p,ul.mw-gallery-packed-hover li.gallerybox.mw-gallery-focused div.gallerytextwrapper:hover p{
      text-overflow:clip;
      white-space:normal;
      overflow:visible
  }
