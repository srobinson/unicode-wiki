...
/* MOBILE */
// https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=site.styles&ext.3d.styles|ext.cite.styles|ext.uls.interlanguage|ext.visualEditor.desktopArticleTarget.noscript|ext.wikimediaBadges|mediawiki.legacy.commonPrint,shared|mediawiki.page.gallery.styles|mediawiki.skinning.interface|mediawiki.toc.styles|skins.vector.styles|wikibase.client.init&only=styles&skin=vector
// https://en.wikipedia.org/w/load.php?debug=false&lang=en&modules=site.styles|ext.3d.styles|ext.cite.styles|ext.uls.interlanguage|ext.visualEditor.desktopArticleTarget.noscript|ext.wikimediaBadges|mediawiki.legacy.commonPrint,shared|mediawiki.page.gallery.styles|mediawiki.skinning.interface|mediawiki.toc.styles|skins.vector.styles|wikibase.client.init&only=styles&skin=vector
export default css`
.wiki {
  cite,dfn{
  ...
  .sysop-show,.templateeditor-show,.extendedmover-show,.patroller-show,.autoconfirmed-show,.user-show{
      display:none
  }
